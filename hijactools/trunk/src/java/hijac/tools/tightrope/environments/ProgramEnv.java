...
public class ProgramEnv
{
  ...
  /**
   * Gets the <code>ParadigmEnv</code> that represents the schedulable sharing a
   * name with the parameter. May return <code>null</code>
   * 
   * @param name
  ...
  /**
   * Gets the object environment within this program environment that shares the
   * same name as the parameter, if it does not exists this method will return
   * <code>null</code>. Internally, this method calls
  ...
  public boolean containsNonParadigmObject(String name)
  {
    for (NonParadigmEnv npe : nonParadigmObjectEnvs)
    {
