...
public class StructureEnv
{
  ...
  private class TierEnv
  {
    ...
    public ArrayList<Name> getMissionSequencers()
    {
      ...
      for (ClusterEnv c : clusters)
      {
        for (ObjectEnv p : c.getSchedulablesEnv().getSchedulableMissionSequencerEnvs())
        {
    ...
    public List toList()
    {
      ...
      for (ClusterEnv c : clusters)
      {
        ...
        schedulablesMap.put("Aperiodics", c.getSchedulablesEnv().getAperiodicsList());
  ...
  public String toString()
  {
    ...
    for (TierEnv tier : tiers)
    {
      ...
      output
          .append("____________________________________________________________________________________");
      output.append(LINE_SEPARATOR);
  ...
  /**
   * Gets the ObjectEnv with the given name, or <code>null</code> if it does not
   * exist.
   * 
   * @param nameOfObject
   *          The name of the ObjectEnv you're searching for
  ...
  private String outputMethods(String output, List<MethodEnv> methods)
  {
    ...
    else
    {
      ...
      for (MethodEnv me : methods)
      {
        ...
        output += "\t\t\t" + me.getReturnType() + ":" + me.getName() + "(" + params + ")";
        output += LINE_SEPARATOR;
      }
    }
    return output;
