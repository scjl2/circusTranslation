...
public class NewCircusTemplates extends CircusTemplates {
   ...
   public NewDataOpMethodModel(NewSCJApplication context) {
      super("DATAOP",
...
//      DATA_OBJECT = FACTORY.getTemplate("DataObject.ftl");
      ...
      try
	{
		...
		FACTORY.CIRCUS_CONFIG.setSharedVariable("ACTION", new MethodBodyVisitor(newSCJApp));
		FACTORY.CIRCUS_CONFIG.setSharedVariable("DATAOP", new NewDataOpMethodModel(newSCJApp));
    	  }
