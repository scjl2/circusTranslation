...
import hijac.tools.scjmsafe.language.Commands.Assignment;
import hijac.tools.scjmsafe.language.Commands.Command;
import hijac.tools.scjmsafe.language.Commands.Declaration;
import hijac.tools.scjmsafe.language.Commands.DoWhile;
import hijac.tools.scjmsafe.language.Commands.EnterPrivateMemory;
import hijac.tools.scjmsafe.language.Commands.ExecuteInAreaOf;
import hijac.tools.scjmsafe.language.Commands.ExecuteInOuterArea;
import hijac.tools.scjmsafe.language.Commands.For;
import hijac.tools.scjmsafe.language.Commands.GetMemoryArea;
import hijac.tools.scjmsafe.language.Commands.If;
import hijac.tools.scjmsafe.language.Commands.MethodCall;
import hijac.tools.scjmsafe.language.Commands.NewInstance;
import hijac.tools.scjmsafe.language.Commands.Scope;
import hijac.tools.scjmsafe.language.Commands.Sequence;
import hijac.tools.scjmsafe.language.Commands.Skip;
import hijac.tools.scjmsafe.language.Commands.Switch;
import hijac.tools.scjmsafe.language.Commands.Try;
import hijac.tools.scjmsafe.language.Commands.While;
import hijac.tools.scjmsafe.language.Expressions.ArrayElement;
import hijac.tools.scjmsafe.language.Expressions.Expr;
import hijac.tools.scjmsafe.language.Expressions.FieldAccess;
import hijac.tools.scjmsafe.language.Expressions.Identifier;
import hijac.tools.scjmsafe.language.Expressions.Null;
import hijac.tools.scjmsafe.language.Expressions.This;
import hijac.tools.scjmsafe.language.Expressions.Val;
import hijac.tools.scjmsafe.language.Expressions.VarType;
import hijac.tools.scjmsafe.language.Expressions.Variable;
import hijac.tools.scjmsafe.language.Method.Method;
import hijac.tools.scjmsafe.language.Method.MethodProperties;
import hijac.tools.scjmsafe.language.Method.MethodRefChange;
import hijac.tools.scjmsafe.language.Method.MethodRefMapping;
import hijac.tools.scjmsafe.language.Method.MethodSig;
import hijac.tools.scjmsafe.language.RefCon.Current;
import hijac.tools.scjmsafe.language.RefCon.CurrentPlus;
import hijac.tools.scjmsafe.language.RefCon.CurrentPrivate;
import hijac.tools.scjmsafe.language.RefCon.Erc;
import hijac.tools.scjmsafe.language.RefCon.IMem;
import hijac.tools.scjmsafe.language.RefCon.MMem;
import hijac.tools.scjmsafe.language.RefCon.MetaRefCon;
import hijac.tools.scjmsafe.language.RefCon.PRMem;
import hijac.tools.scjmsafe.language.RefCon.Prim;
import hijac.tools.scjmsafe.language.RefCon.Rcs;
import hijac.tools.scjmsafe.language.RefCon.RefCon;
import hijac.tools.scjmsafe.language.RefCon.TPMMem;
import hijac.tools.scjmsafe.language.RefCon.TPMem;
