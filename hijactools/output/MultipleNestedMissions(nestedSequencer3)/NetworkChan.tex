...
\t1 start\_mission~.~NestedMissionA, done\_mission~.~NestedMissionA,\\
\t1 initializeRet~.~NestedMissionA,
requestTermination~.~NestedMissionA~.~mainSequencer

, \\
\t1 start\_mission~.~NestedMissionB, done\_mission~.~NestedMissionB,\\
\t1 initializeRet~.~NestedMissionB,
requestTermination~.~NestedMissionB~.~mainSequencer
