...
\begin{circus}
\circchannelset ~ TierSync == \\ \t1 \lchanset start\_mission~.~TopMission1, done\_mission~.~TopMission1,\\
...
\t1 start\_mission~.~MyMission1, done\_mission~.~MyMission1,\\
\t1 initializeRet~.~MyMission1,
requestTermination~.~MyMission1~.~MySequencer
...
\t1 start\_mission~.~MyMission2, done\_mission~.~MyMission2,\\
\t1 initializeRet~.~MyMission2,
requestTermination~.~MyMission2~.~
...
\t1 start\_mission~.~MyMission3, done\_mission~.~MyMission3,\\
\t1 initializeRet~.~MyMission3,
requestTermination~.~MyMission3~.~
